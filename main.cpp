...
//#define SSID   "UPC84BBE8F"  // Network must be visible otherwise it can't connect
#define SSID "MULTI-TELEKOM.PL_99z"
#define PASSW  "w3u6ge3i9f"
...
int publish(MQTT::Client<MQTTWiFi, Countdown, MQTT_MAX_PACKET_SIZE>* client, MQTTWiFi* ipstack)
{
 ...
 //   temp = 48.0;
   ...
   // hum = 199.9;
    ...
    sprintf(buf,
     "{\"d\":{\"ST\":\"Nucleo-IoT-mbed\",\"Temp\":%0.4f,\"Pressure\":%0.4f,\"Humidity\":%0.4f}}", temp, press, hum);

//    sprintf (buf, "test do wyslania gd");
...
//    Timer tyeld;
 ...
 //   X_NUCLEO_IKS01A2 *mems_expansion_board = X_NUCLEO_IKS01A2::instance(D14, D15, D4, D5);
    auto p_mems_expansion_board = XNucleoIKS01A2::instance(IKS01A2_PIN_I2C_SDA,IKS01A2_PIN_I2C_SCL);
    pressure_sensor = p_mems_expansion_board->pt_sensor;
    temp_sensor1 = p_mems_expansion_board->ht_sensor;
    humidity_sensor = p_mems_expansion_board->ht_sensor;
